...
class LogisticRegression(object):
    ...
    text classification."""
    def __init__(self, training_set_path, test_set_path, initial_weight=0.0,
                 lamda=0.1, eeta=0.1, acceptable_delta=1):
    ...
    def train_logistic_regression(self):
        ...
        i = 0
        while diff > self.acceptable_delta and i <= 500:
            new_weights = {}
...
def main():
    ...
    lg = LogisticRegression(args.tr[0], args.te[0])
